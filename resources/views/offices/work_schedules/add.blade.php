...
@section('title', 'Добавить График Работы Офиса')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Добавить График Работы Офиса</h1>
        <a href="{{route('work_schedules.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Добавить График Работы Офиса</h6>
        </div>
        <form method="POST" action="{{route('work_schedules.store')}}">
            @csrf
            <div class="card-body">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <select class="form-control form-control-user @error('type_of_client_id') is-invalid @enderror" name="type_of_client_id">
                            ...
                            @foreach ($typeOfClients as $typeOfClient)
                                <option value="{{$typeOfClient->id}}">{{$typeOfClient->name}}</option>
                            @endforeach
                        </select>
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('work_schedules.index') }}">Отменить</a>
            </div>
        </form>
    </div>
