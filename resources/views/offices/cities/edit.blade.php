...
@section('title', 'Изменить Название Города')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Изменить Название Города</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Изменить Название Города</h6>
        </div>
        <form method="POST" action="{{route('cities.update', ['city' => $city->id])}}">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        <label for="name"><span style="color:red;">*</span>Город</label>
                        <input
                            type="text"
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('cities.index') }}">Назад</a>
            </div>
        </form>
    </div>
